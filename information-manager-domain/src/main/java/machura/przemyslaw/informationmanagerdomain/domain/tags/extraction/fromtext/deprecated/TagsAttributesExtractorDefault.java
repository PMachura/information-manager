...
public class TagsAttributesExtractorDefault implements TagsAttributesExtractor {
    ...
    @Override
    public Either<List<Fault>, List<TagAttr>> extractAttributes(String tag) {
     ...
     */
    private List<TagAttr> toTagAttributes(List<Tuple2<String, String>> attributesNamesWithValues) {
